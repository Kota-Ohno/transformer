...
ACCUMULATED_BATCHES = CONFIG["ACCUMULATED_BATCHES"]
TRANSLATION_SOURCE = CONFIG["TRANSLATION_SOURCE"]
TRANSLATION_DESTINATION = CONFIG["TRANSLATION_DESTINATION"]
TRANSLATION_SOURCE2 = CONFIG["TRANSLATION_SOURCE2"]
TRANSLATION_DESTINATION2 = CONFIG["TRANSLATION_DESTINATION2"]
TOKENIZE_BATCH_SIZE = CONFIG["TOKENIZE_BATCH_SIZE"]
LAYER_DROPOUT = CONFIG["LAYER_DROPOUT"]
WEIGHT_DECAY = CONFIG["WEIGHT_DECAY"]

# データ拡張関連の設定
DATA_AUGMENTATION_FACTOR = CONFIG["DATA_AUGMENTATION_FACTOR"]
DATA_AUGMENTATION_TECHNIQUES = CONFIG["DATA_AUGMENTATION_TECHNIQUES"]
TOKEN_MASK_PROB = CONFIG["TOKEN_MASK_PROB"]
TOKEN_DELETE_PROB = CONFIG["TOKEN_DELETE_PROB"]
TOKEN_REPLACE_PROB = CONFIG["TOKEN_REPLACE_PROB"]
TOKEN_PERMUTE_PROB = CONFIG["TOKEN_PERMUTE_PROB"]
BACK_TRANSLATION_BATCH_SIZE = CONFIG["BACK_TRANSLATION_BATCH_SIZE"]

# エラーハンドリング関連設定
MAX_RETRY_COUNT = CONFIG["MAX_RETRY_COUNT"]
ERROR_SKIP_THRESHOLD = CONFIG["ERROR_SKIP_THRESHOLD"]
