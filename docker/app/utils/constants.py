...
# バッチサイズ関連
DEFAULT_BATCH_SIZE_SMALL_VRAM: Final[int] = 8  # 4GB以下のVRAM用
DEFAULT_BATCH_SIZE_MEDIUM_VRAM: Final[int] = 16  # 4GB超8GB以下のVRAM用
DEFAULT_BATCH_SIZE_LARGE_VRAM: Final[int] = 32  # 8GB超のVRAM用
